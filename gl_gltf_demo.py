from pugtk import Vector3, Matrix4, Camera, color, load_gltf
from pugtk._renderer3d_gl import GLRenderer3D, GLWindow

window = GLWindow("lumen3dengine glTF loader demo", 640, 480)
camera = Camera(
    Vector3(0.0, 0.0, 5.0),
    Vector3(0.0, 0.0, 0.0),
    Vector3(0.0, 1.0, 0.0),
...
mesh = load_gltf("test_cube.gltf")
mesh_color = color(230, 120, 60)
